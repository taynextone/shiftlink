...
describe('registration and signed match flow', () => {
    ...
    it('registers a nurse and returns an auth cookie', async () => {
        ...
        prisma.user.create.mockResolvedValue({
            ...
            nurseProfile: {
                ...
                minHourlyRate: new client_1.Prisma.Decimal(42),
    ...
    it('signs a match, updates shift status, and enqueues billing + whatsapp jobs', async () => {
        prisma.matchContract.findUnique.mockResolvedValue({
            id: 'contract_1',
            status: client_1.MatchContractStatus.PENDING,
            nurseProfile: {
                whatsappOptIn: true,
                phoneNumber: '+491701234567',
            },
        ...
        prisma.matchContract.update.mockResolvedValue({
            id: 'contract_1',
            status: client_1.MatchContractStatus.SIGNED,
            ...
            jobShift: {
                id: 'shift_1',
                status: client_1.JobShiftStatus.MATCHED,
                hospitalProfile: {
                    id: 'hospital_1',
                },
            },
        ...
        const response = await (0, supertest_1.default)(app).post('/api/v1/matches/sign').send({
            matchContractId: 'contract_1',
        });
        expect(response.status).toBe(200);
        expect(response.body.matchContract.status).toBe(client_1.MatchContractStatus.SIGNED);
    ...
    it('creates an invoice amount based on total planned hours times platform fee', async () => {
        ...
        prisma.matchContract.findUnique.mockResolvedValue({
            ...
            invoice: null,
            jobShift: {
                totalPlannedHours: new client_1.Prisma.Decimal(12.5),
            },
        });
        prisma.invoice.create.mockResolvedValue({
            id: 'invoice_1',
            matchContractId: 'contract_2',
            amount: new client_1.Prisma.Decimal(37.5),
